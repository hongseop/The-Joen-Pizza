...
public class QABoardController {
	...
	public String QAlist(Model model ,HttpServletRequest request) throws Exception {
				//여기서부터 페이지 불러오기
				System.out.println("확인중 : QABoard-Alist");
				...
				System.out.println("count 값 : "+qaboarddao.QAcountNo());
				...
				if(count >= 0){
					...
					System.out.println("test-QABoard-Alist-middle");
				...
				System.out.println("확인중 : QABoard-Alist-return");
		return "main";
	}
	...
	public String QAlistAction(Model model,HttpSession session,HttpServletRequest request)  {
		System.out.println("확인중 : QABoard-AlistAction");
	...
	public RedirectView QACommentInsert(Model model,QAReplyVo qr,HttpSession session,HttpServletRequest hrs) {
		...
		System.out.println("추적중 : QAcommentInsert : " + userVo);
		qr.setUserName(userVo.getUserName());
		qr.setUserNum(userNum);
		System.out.println("추적중 : QAcommentInsert : -qr " + qr);
		qaboarddao.QACommentInsert(qr);
		System.out.println("추적중 : QAcommentInsert : end" + qr);
